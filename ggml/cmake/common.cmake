...
function(ggml_cuda_fattn_vec_instances DIR OUT_SRCS)
    ...
    if (WIN32 AND GGML_HIP)
        # hipcc removes string quotes when forwarding Windows command arguments.
        add_compile_definitions(GGML_HIP_FA_QUANTS_TOKENS=${FA_QUANTS_DEFINE})
    else()
